    ...
    >
      ...
      <div className="lg:pl-[20%] pt-[6%] md:pr-[5%]">
        <div className="grid grid-cols-1 sm:grid-cols-2 place-items-baseline gap-6">
          <div>
            <span className="uppercase font-bold py-1 text-xs md:text-sm lg:text-base px-2 bg-zinc-600 rounded-md text-white">
              JavaScript
            </span>
            <p className="xl:text-xl 2xl:text-2xl text-zinc-600 lg:text-lg md:text-base max-w-md mt-1 lg:mt-2 text-sm text-justify md:text-start">
