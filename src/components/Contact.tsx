...
export function Contact() {
  return (
    ...
    >
      ...
      <div className="mb-[6%] space-y-8 pt-[6%] tablet-md:pr-[5%] laptop-sm:pl-[20%]">
        <div className="grid grid-cols-[40px_1fr] grid-rows-1 place-items-start border-b border-b-slate-400 tablet-md:grid-cols-[1fr]">
          <div>
            ...
            <a
              ...
              className="text-xs font-semibold text-zinc-600 tablet-md:text-sm laptop-sm:text-lg desktop-md:text-xl full-hd:text-2xl"
              target="_blank"
              rel="noreferrer"
            >
