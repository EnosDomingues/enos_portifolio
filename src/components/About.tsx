export function About() {
  return (
    <section
      className="flex scroll-mt-44 flex-col leading-relaxed tracking-wide tablet-md:min-h-[calc(100vh-8rem)] "
      id="about"
    >
      ...
      <div className="space-y-4 pt-[6%] text-sm tablet-md:pr-[5%] tablet-md:text-base laptop-sm:pl-[20%] laptop-sm:text-lg desktop-sm:text-xl desktop-md:text-2xl full-hd:text-3xl">
        <p className="text-justify tablet-md:text-start">
        ...
        <p className="text-justify laptop-sm:mt-8">
